...
<main class="main">
        ...
        <div class="container">
            ...
            <div class="row gy-3">
                ...
                <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
                    <img src="static/assets/img/about.jpg" alt="" class="img-fluid">
                </div>
        ...
        <div class="container">
            ...
            <div class="swiper init-swiper">
                ...
                <div class="swiper-wrapper align-items-center">
                    <div class="swiper-slide"><img src="static/assets/img/clients/client-1.png" class="img-fluid" alt=""></div>
                    <div class="swiper-slide"><img src="static/assets/img/clients/client-2.png" class="img-fluid" alt=""></div>
                    <div class="swiper-slide"><img src="static/assets/img/clients/client-3.png" class="img-fluid" alt=""></div>
                    <div class="swiper-slide"><img src="static/assets/img/clients/client-4.png" class="img-fluid" alt=""></div>
                    <div class="swiper-slide"><img src="static/assets/img/clients/client-5.png" class="img-fluid" alt=""></div>
                    <div class="swiper-slide"><img src="static/assets/img/clients/client-6.png" class="img-fluid" alt=""></div>
                    <div class="swiper-slide"><img src="static/assets/img/clients/client-7.png" class="img-fluid" alt=""></div>
                    <div class="swiper-slide"><img src="static/assets/img/clients/client-8.png" class="img-fluid" alt=""></div>
                </div>
            </div>
    ...
    <section id="contact" class="contact section">
        ...
        <div class="container section-title" data-aos="fade-up">
            <h2>Liên hệ</h2>
            <p><span>Bạn cần trợ giúp?</span></p> <p> <span class="description-title">Để lại thông tin bên dưới và chúng tôi sẽ liên lạc trong thời gian sớm nhất</span></p>
        </div><!-- End Section Title -->
        ...
        <div class="container" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-7">
                    <form action="/contact" method="post" class="php-email-form" data-aos="fade-up" data-aos-delay="200" id="contactForm">
                        <div class="row gy-4">
                            ...
                            <div class="col-md-6">
                                <label for="phone-field" class="pb-2">Số điện thoại</label>
                            ...
                            <div class="col-md-12">
                                <label for="need-field" class="pb-2">Nhu cầu</label>
                                <textarea class="form-control" name="need" rows="10" id="need-field" required=""></textarea>
                            </div>
        ...
        <div class="container">
            <div class="row justify-content-center text-center">
                <div class="col-lg-6">
                    ...
                    <p>Đăng ký để nhận thông tin mới nhất về sản phẩm và dịch vụ của chúng tôi.</p>
        ...
        <div class="row gy-4">
            <div class="col-lg-4 col-md-6 footer-about">
                ...
                <div class="footer-contact pt-3">
                    ...
                    <p class="mt-3"><strong>Phone:</strong> <span>+84 364 441 833</span></p>
                    <p><strong>Email:</strong> <span>mvkhanh100204@gmail.com</span></p>
                </div>
            </div>
...
<script>
    $(document).ready(function() {
        // Đảm bảo rằng chỉ có một sự kiện submit được gán
        $('#contactForm').off('submit').on('submit', function(event) {
            ...
            $sentMessage.hide(); // Ẩn thông báo thành công

            $.ajax({
                type: $form.attr('method'),
                url: $form.attr('action'),
                data: $form.serialize(), // Chuyển đổi dữ liệu form thành chuỗi
                success: function(response) {
                    if ($.trim(response) === 'Success') {
                        $loading.hide(); // Ẩn thông báo đang tải
                        $sentMessage.show(); // Hiển thị thông báo thành công
                    } else {
                        $loading.hide(); // Ẩn thông báo đang tải
                        $errorMessage.text('Unexpected response from server: ' + response).show(); // Hiển thị thông báo lỗi
                    }
                },
                error: function(xhr) {
                    $loading.hide(); // Ẩn thông báo đang tải
                    $errorMessage.text('An error occurred: ' + xhr.responseText).show(); // Hiển thị thông báo lỗi
                }
            });
        });
    });
